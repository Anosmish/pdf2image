...
if (!file_exists($uploadedPath)) respondError("Uploaded PDF not found: $uploadedPath", 400);
...
chmod($workDir, 0777);
error_log("Working directory: $workDir");
...
try {
    ...
    if (empty($images)) respondError('No images generated. Check PDF & Ghostscript', 500);
